...
const DATA = [
  {
    ...
    docente: "Dra. Elena Ríos",
    temas: ["matemáticas", "cálculo"],
  },
  {
    id: "r2",
    titulo: "Física Cuántica: Conceptos Clave",
    docente: "Prof. Javier Soto",
    temas: ["física", "cuántica"],
  },
  {
    id: "r6",
    titulo: "Programación en JavaScript",
    docente: "Ing. Diego Mena",
    temas: ["programación", "javascript"],
  },
];
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-neutral-600">
        Encuentra repositorios por palabra clave, tema o docente.
      </p>
        ...
        {list.map((r) => (
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => setFavs((f) => ({ ...f, [r.id]: !f[r.id] }))}
