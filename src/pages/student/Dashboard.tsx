...
const StudentDashboard = () => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-h1 font-bold text-primary-contrast">¡Bienvenido, Estudiante!</h1>
        <p className="text-neutral-600">Aquí tienes un resumen de tu progreso académico.</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            {isLoading ? <Skeleton className="h-8 w-16" /> : <div className="text-h2 font-bold">5</div>}
              ...
              <Card className="hover:shadow-lg transition-all cursor-pointer hover:border-brand-action/30">
                <CardContent className="p-6">
                  <div className="flex items-center gap-4 p-4 bg-neutral-50 rounded-lg">
                    ...
                    <div>
                      <h3 className="text-h3 font-semibold text-primary-contrast mb-1">{action.title}</h3>
